 ...
 * Light Theme
 *
 * The default light theme implementation using the design tokens
...
export const lightTheme = createTheme(themeContract, {
  color: {
    ...
    semantic: {
      background: {
        default: ColorCoreNeutral0, // White background
        subtle: ColorCoreNeutral50, // Very light gray
        muted: ColorCoreNeutral100, // Light gray
        emphasis: ColorCoreNeutral900, // Dark background for emphasis
        inverse: ColorCoreNeutral950, // Almost black
      },
      text: {
        default: ColorCoreNeutral900, // Dark text on light background
        subtle: ColorCoreNeutral700, // Medium-dark gray text
        muted: ColorCoreNeutral500, // Muted gray text
        inverse: ColorCoreNeutral0, // White text for dark backgrounds
        accent: ColorCorePrimary600, // Primary blue for accent text
        success: ColorCoreSuccess600, // Success green text
        warning: ColorCoreWarning600, // Warning amber text
        error: ColorCoreError600, // Error red text
      },
      border: {
        default: ColorCoreNeutral200, // Light border
        subtle: ColorCoreNeutral100, // Very light border
        muted: ColorCoreNeutral300, // Medium-light border
        emphasis: ColorCoreNeutral400, // Emphasized border
        accent: ColorCorePrimary500, // Primary blue border
      ...
      surface: {
        default: ColorCoreNeutral0, // White surface
        subtle: ColorCoreNeutral50, // Very light surface
        muted: ColorCoreNeutral100, // Light surface
        emphasis: ColorCoreNeutral200, // Emphasized surface
        inverse: ColorCoreNeutral900, // Dark surface for contrast
      },
    },
  },

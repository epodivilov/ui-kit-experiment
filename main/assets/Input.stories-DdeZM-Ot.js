import{i as e,l as t}from"./iframe-DOd3Lpa1.js";import{t as n}from"./jsx-runtime-Bv32N4AW.js";import"./react-dom-DLGS5tKk.js";import{t as r}from"./createRuntimeFn-62c9670f.esm-DKWA1Tvk.js";import{a as i,c as a,n as o,o as s,r as c,s as l,t as u}from"./createBaseUIEventDetails-D9hCgO_i.js";import{f as d,m as f,o as p}from"./useLatestRef-fxzx-GHQ.js";var m=t(e());const h=m.forwardRef(function(e,t){let{render:n,className:r,id:h,name:g,value:_,disabled:v=!1,onValueChange:y,defaultValue:b,...x}=e,{state:S,name:C,disabled:w}=i(),T=w||v,E=C??g,D=m.useMemo(()=>({...S,disabled:T}),[S,T]),{setControlId:O,labelId:k,setTouched:A,setDirty:j,validityData:M,setFocused:N,setFilled:P,validationMode:F}=i(),{getValidationProps:I,getInputValidationProps:L,commitValidation:R,inputRef:z}=c(),B=s(h);d(()=>(O(B),()=>{O(void 0)}),[B,O]),d(()=>{let e=_!=null;z.current?.value||e&&_!==``?P(!0):e&&_===``&&P(!1)},[z,P,_]);let[V,H]=a({controlled:_,default:b,name:`FieldControl`,state:`value`}),U=_!==void 0,W=f((e,t)=>{y?.(e,t),!t.isCanceled&&H(e)});return o({id:B,name:E,commitValidation:R,value:V,getValue:()=>z.current?.value,controlRef:z}),p(`input`,e,{ref:t,state:D,props:[{id:B,disabled:T,name:E,ref:z,"aria-labelledby":k,...U?{value:V}:{defaultValue:b},onChange(e){let t=e.currentTarget.value;W(t,u(`none`,e.nativeEvent)),j(t!==M.initialValue),P(t!==``)},onFocus(){N(!0)},onBlur(e){A(!0),N(!1),F===`onBlur`&&R(e.currentTarget.value)},onKeyDown(e){e.currentTarget.tagName===`INPUT`&&e.key===`Enter`&&(A(!0),R(e.currentTarget.value))}},I(),L(),x],stateAttributesMapping:l})});var g=t(n());const _=m.forwardRef(function(e,t){return(0,g.jsx)(h,{ref:t,...e})});var v=r({defaultClassName:`owugrx0`,variantClassNames:{variant:{default:`owugrx1`,error:`owugrx2`}},defaultVariants:{variant:`default`},compoundVariants:[]});const y=(0,m.forwardRef)(({variant:e,type:t=`text`,...n},r)=>(0,g.jsx)(_,{ref:r,type:t,className:v({variant:e}),...n}));y.displayName=`Input`,y.__docgenInfo={description:`Input Component

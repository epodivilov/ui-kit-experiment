import{i as e,l as t}from"./iframe-DOd3Lpa1.js";import{t as n}from"./jsx-runtime-Bv32N4AW.js";import{t as r}from"./Button-BYYLpffM.js";import"./createRuntimeFn-62c9670f.esm-DKWA1Tvk.js";var i=t(e()),a=t(n()),o=(0,i.createContext)(void 0);const s=({children:e,defaultTheme:t=`light`})=>{let[n,r]=(0,i.useState)(t);(0,i.useEffect)(()=>{if(!(typeof window>`u`))return document.documentElement.setAttribute(`data-theme`,n),()=>{document.documentElement.removeAttribute(`data-theme`)}},[n]);let s=(0,i.useMemo)(()=>({theme:n,setTheme:r}),[n]);return(0,a.jsx)(o.Provider,{value:s,children:e})};s.displayName=`ThemeProvider`;const c=()=>{let e=(0,i.useContext)(o);if(e===void 0)throw Error(`useTheme must be used within a ThemeProvider`);return e};s.__docgenInfo={description:`ThemeProvider Component
